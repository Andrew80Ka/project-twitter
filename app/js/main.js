$(document).ready(function() {
	...
	var createTweet = function(date, text) {
		...
		var $tweetText = $('<div class="tweet-text">').html(wrapURLs(text)).wrapInner('<p></p>');//Создаем контент с Твиттом
		...
		$tweetBox.append($tweetDate).append($tweetText);//Получаем разметку твитта с датой и текстом твитта
	...
	$('#postNewTweet').on('submit', function(e) {
		...
		$('#tweetText').val('');//чистим строчку заполнеия твитта
	});
